...
class CoverAddCard extends StatefulWidget {
  final String slug;
  final CoverModel? data;
  final Function(CoverModel) onCoverChanged;
  ...
  @override
  _CoverAddCardState createState() => _CoverAddCardState();
}

class _CoverAddCardState extends State<CoverAddCard> {
